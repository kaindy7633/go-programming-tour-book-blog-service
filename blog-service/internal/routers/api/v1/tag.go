...
import (
	...
	"github.com/kaindy7633/go-programming-tour-book/blog-service/internal/service"
	"github.com/kaindy7633/go-programming-tour-book/blog-service/pkg/app"
	"github.com/kaindy7633/go-programming-tour-book/blog-service/pkg/convert"
	"github.com/kaindy7633/go-programming-tour-book/blog-service/pkg/errcode"
)
...
func (t Tag) Delete(c *gin.Context) {
	param := service.DelteteTagRequest{ID: convert.StrTo(c.Param("id")).MustUInt32()}
	response := app.NewResponse(c)
	valid, errs := app.BindAndValid(c, &param)
	if !valid {
		global.Logger.Errorf("app.BindAndValid errs: %v", errs)
